...
import math
import cv2
from processing.preprocessing import GeoTrans, decom_pano_name, statistic_data_pixel, statistic_data
...
class ReliableLoc():
    ...
    def save_results(self):
        ...
        print('--------------------------------------------------------------')
        print('the rasac result:')
        statistic_data(loc_err)
        print('--------------------------------------------------------------')
        print('the nfa validation result: ')
        statistic_data(loc_err2)
        print('--------------------------------------------------------------')
